...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div><AskLLM defaultQuery="jak analizować wyniki fermy drobiu FCR upadki marża" contextUrl="https://fermly.pl/przewodnik-stado-drob.html" summaryUrl="/przewodnik-stado-drob.summary.txt" /></div>
